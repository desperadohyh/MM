START_DIR = C:\Users\jessl\DOCUME~1\GitHub\MM

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2017b
MAKEFILE = testMEX_mex.mk

include testMEX_mex.mki
...
SRC_FILES =  \
	...
	testMEX_terminate.c \
	testMEX.c \
	_coder_testMEX_info.c \
	_coder_testMEX_api.c \
	_coder_testMEX_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = testMEX_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\testMEX"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\testMEX/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
