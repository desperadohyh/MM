function [Z1, A, B ] = LinKin_exf(z0_, U0, Ts,exf)
%z0_ = zeros(1,19);
%Ts = 1;
r = 0.0215;
d = 0.13;
...
A = [ 1   0    0    0  Ts*cos(Z6_) -z0_(5)*Ts*sin(Z6_) -0.5*(Ts^2)*z0_(5)*sin(Z6_) zeros(1,12);
      ...
      zeros(1,5)        -0.5*r*(z0_(9)+z0_(11))*sin(Z6_) 0 0 r*0.5*cos(Z6_) 0 r*0.5*cos(Z6_) zeros(1,8);
      zeros(1,5)        0.5*r*(z0_(9)+z0_(11))*cos(Z6_) 0 0 r*0.5*sin(Z6_) 0 r*0.5*sin(Z6_) zeros(1,8);
